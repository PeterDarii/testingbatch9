...
import org.junit.runner.RunWith;
    ...
    @CucumberOptions(
            ...
            //we provide the path package for steps
            ...
            //if we set dry run to true, it will quickly scan all gherkin steps implemented or not
            ...
            monochrome=true,
            //if strict is set to true at the time of execution if cucumber encounters any undefined
            //steps, it will give an error and stops execution. Also it gives code snippet for the unimplemented steps
            //strict = true
            tags = "@simpletag",
